...
btnYes.addEventListener('click',ToggleModal)


const deleteButtons = document.querySelectorAll(".btn-yes");

for (const deleteButton of deleteButtons) {
  deleteButton.addEventListener("click", function() {
    
    const productList = document.getElementById("list-san-pham");
    const productToRemove = document.getElementById("fav-product-6");
